...
if (enableTemplate) {
  ...
  // Display the Print and Email buttons
...
emailButton.addEventListener("click", function () {
  ...
  const contentToEmail = generatedContent.innerHTML;

  // Open the default email client with pre-populated content
  window.location.href = "mailto:?subject=Generated Content&body=" + encodeURIComponent(contentToEmail);
});
