document.addEventListener("DOMContentLoaded", function () {
  ...
  worldForm.addEventListener("submit", function (event) {
    ...
    if (settlementPOICountInput.value === "random") {
        settlementPOICount = Math.floor(Math.random() * 5) + 1;
    } else {
    ...
    if (racesCountInput.value === "random") {
        racesCount = Math.floor(Math.random() * 5) + 1; // Generate a random number from 1 to 5 for races
    } else {
