  ...
  worldForm.addEventListener("submit", function (event) {
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <img src="${selectedSettlement.image}" alt="${settlements.name}" class="shadow-sm .img-fluid" style="max-width: 100%; max-height: auto; margin-bottom: 10px; border-radius: 10px">
      </div>
      <div class="col-md-6">
        <div class="container">
