document.addEventListener("DOMContentLoaded", function () {
  ...
  const races = [
    ...
    {
      name: "Mousefolk",
      link: "https://chaidgpt.github.io/TheBardicLexicon/playerResources/racePages/mousefolk.html",
      image: "../images/mousefolk.jpg"
    },
    {
      name: "Orcs",
  ...
  const encounters = [
    ...
    {
      name: "A Cursed Graveyard",
      description: "A small, overgrown graveyard radiates unnatural cold. The air is thick with whispers of the dead."
    },
    {
      name: "A Giant's Handprint",
      description: "A massive handprint is embedded in the ground. It looks ancient, but the soil around it seems freshly disturbed."
    },
    {
      name: "A Shifting Mirage",
      description: "A mirage appears in the distance, showing a place that shouldn’t exist—an ancient city, a battlefield, or a lost island."
    },
  ];  
